            ...
            return o
                ...
                1 : [function(t, e, n) {
                    ...
                    d.prototype._initTouchEvents = function() {
                        ...
                        a.addEventListener(l.move,
                            function(e) {
                                if (t._moved) {
                                    e.preventDefault()
                                }
                            });
                        this.panel.addEventListener(l.start,
                            function(e) {
                        ...
                        this.panel.addEventListener(l.end,
                            function() {
                                if (t._moved) {
                        ...
                        this.panel.addEventListener(l.move,
                            function(e) {
