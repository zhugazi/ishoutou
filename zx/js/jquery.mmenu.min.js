...
(function(a) {
    function i(b) {
        ...
        b.addCounters !== void 0 && (a.fn.mmenu.deprecated("addCounters-option", "counters.add-option"), b.counters = {
            add: b.addCounters
        }),
        b.closeOnClick !== void 0 && (a.fn.mmenu.deprecated("closeOnClick-option", "onClick.close-option"), b.onClick = {
            ...
            "boolean" == typeof b.counters ? b.counters = {
                add: b.counters,
                count: b.counters
            }: "object" != typeof b.counters && (b.counters = {}),
            "boolean" == typeof b.onClick ? b.onClick = {
                close: b.onClick
            }: "object" != typeof b.onClick && (b.onClick = {}),
            "boolean" == typeof b.searchfield ? b.searchfield = {
                add: b.searchfield,
            ...
            }: "object" != typeof b.searchfield && (b.searchfield = {}),
            b
    }
    function j(a) {
    ...
    function l(b, c) {
        return b.is(c.menuNodetype) || (b = a("<" + c.menuNodetype + " />").append(b)),
            ...
            a("li." + c.labelClass, b).removeClass(c.labelClass).addClass(y("label")),
            b
    }
    function m(b, c, d) {
        b.addClass(y(c)),
    ...
    function n(b, c) {
        return b || (b = a('<div id="' + y("blocker") + '" />').appendTo(d)),
            x(b,
                function() {
                    c.trigger(A("close"))
                }),
    ...
    function p(b, c, d) {
        a("em." + d.counterClass, b).removeClass(d.counterClass).addClass(y("counter")),
        c.add && a("." + y("submenu"), b).each(function() {
            var c = a(this),
                d = c.attr("id");
            if (d && d.length) {
    ...
    function q(b, c) {
        if (c.add) {
            ...
            d.append('<input placeholder="' + c.placeholder + '" type="text" autocomplete="off" />'),
            c.noResults && a("ul", b).not("." + y("submenu")).append('<li class="' + y("noresults") + '">' + c.noResults + "</li>")
        }
        if (c.search) {
            var d = a("div." + y("search"), b),
                ...
                i = "> a";
            c.showLinksOnly || (i += ", > span"),
                e.bind(A("keyup"),
                    function() {
                        var c = e.val().toLowerCase();
                        h.add(f).addClass(y("noresult")),
                            h.each(function() {
                                var b = a(this);
                            ...
                            b[h.not("." + y("noresult")).length ? "removeClass": "addClass"](y("noresults")),
                            g.trigger(A("count"))
                    })
        }
    }
