...
(function($){
    $.fn.yxMobileSlider = function(settings){
        ...
        return this.each(function(){
            ...
            //初始化焦点容器及按钮
            _this.append('<div class="h_focus"><div class="fix_wrap"></div></div>');
            var oFocusContainer = $(".h_focus");
            for (var i = 0; i < num; i++) {
            ...
            oFocus.first().addClass("h_current");
            //页面加载或发生改变
            ...
            function doMove(){
                ...
                oFocus.eq(iCurr).addClass("h_current").siblings().removeClass("h_current");
            }
            //绑定触摸事件
