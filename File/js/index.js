$(function(){
  $("#doughnutChart").drawDoughnutChart([
    ...
    { title: "可用资金", value:  799.80,   color: "#007eab" },
    { title: "待收本金",      value:  799.80,   color: "#fca72b" },
    { title: "待收利息",        value : 99.80,   color: "#484448" },
    { title: "冻结资金",         value : 799.80,  color: "#e94d1c" }
...
;(function($, undefined) {
  $.fn.drawDoughnutChart = function(data, options) {
    ...
    var $svg = $('<svg width="' + W + '" height="' + H + '" viewBox="0 0 ' + W + ' ' + H + '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"></svg>').appendTo($this),
        ...
        cutoutRadius = doughnutRadius * (settings.percentageInnerCutout / 90),
        segmentTotal = 0;
    ...
    var drawBaseDoughnut = function() {
        ...
        var startRadius = 0,// -Math.PI/2
            segmentAngle = 0,// 1 * ((99.9999/100) * (PI*2)),
    ...
    function drawPieSegments (animationDecimal) {
      var startRadius = -105*(Math.PI/180),//-90 degree
          rotateAnimation = 1;
